        ...
        <form onSubmit={handleVerifyOTP} className="space-y-6 flex flex-col">
          <div className="flex flex-col gap-2 w-full">
            ...
            <label className="text-gray-400">
              <input autoFocus type="text" maxLength={6} pattern="\d{6}" value={otp} onChange={(e) => setOTP(e.target.value)} placeholder="------" required className="w-full px-4 py-2 text-center " />
            </label>
          </div>
