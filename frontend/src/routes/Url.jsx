...
export { shopDeleteURL, productDeleteURL, loginUrl, verifyTokenURL, usersUrl, registerURL, shopCreateURL, productCreateURL, shopsURL, productsURL, productUpdateURL, assignURL, unassignURL, getassignedshopsURL, memberShopsURL, usersLockingUrl };
