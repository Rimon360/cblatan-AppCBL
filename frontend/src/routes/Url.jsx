...
export { shopDeleteURL, productDeleteURL, loginUrl, verifyTokenURL, usersUrl, registerURL, shopCreateURL, productCreateURL, shopsURL, productsURL, productUpdateURL, assignURL, unassignURL, getassignedshopsURL, memberShopsURL, usersLockingUrl, UserUpdateURL, whitelistURL,browserUrl,profileGroupDataURL,blacklistUrlPath };
