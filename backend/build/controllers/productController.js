...
module.exports.createProduct = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(req, res) {
    var _req$file;
    var file_path, _req$body, shop_id, domain, email, password, course_name, hashedPassword, products, decryptedPassword;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        case 0:
          file_path = req === null || req === void 0 || (_req$file = req.file) === null || _req$file === void 0 ? void 0 : _req$file.path; // Assuming the file upload is handled by multer and file_path is available 
          console.log(req === null || req === void 0 ? void 0 : req.path);
          _req$body = req.body, shop_id = _req$body.shop_id, domain = _req$body.domain, email = _req$body.email, password = _req$body.password, course_name = _req$body.course_name;
        ...
        case 1:
          products = _context.v;
          if (products) {
            decryptedPassword = decrypt(products.password, process.env.CRYPTO_KEY);
...
module.exports.getImage = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(req, res) {
    var file_path, filePath;
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.n) {
        case 0:
          file_path = req.params.file_path; // Assuming the file upload is handled by multer and file_path is available   
          if (!file_path) {
            _context2.n = 2;
            break;
          }
          ...
          return _context2.a(2, res.sendFile(filePath));
        case 1:
          res.status(404).json({
      ...
      while (1) switch (_context5.n) {
        ...
        case 1:
          ...
          products.forEach(function (product, i) {
            if (product.password) {
              var decryptedPassword = decrypt(product.password, process.env.CRYPTO_KEY);
...
module.exports.deleteProductById = /*#__PURE__*/function () {
  var _ref8 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee8(req, res) {
    var id, productData, media_path, _fs, products, _t3;
    return _regenerator().w(function (_context8) {
      while (1) switch (_context8.n) {
        ...
        case 2:
          productData = _context8.v;
          if (productData) {
            media_path = productData.file_path;
            if (media_path) {
              _fs = require("fs");
              _fs.unlink(media_path, function (err) {
                if (err) {
