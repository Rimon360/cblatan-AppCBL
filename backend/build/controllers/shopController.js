...
module.exports.assignShop = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(req, res) {
    var _req$body, shop_id, user_id, shop, random, shops;
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.n) {
        ...
        case 2:
          _context2.n = 3;
          return assignModel.findById(shop_id);
        case 3:
          shop = _context2.v;
          if (!shop) {
            _context2.n = 4;
          ...
          return _context2.a(2, res.status(404).json({
            message: "Credentials already assigned"
          }));
        case 4:
          random = seq();
          _context2.n = 5;
        ...
        case 5:
          ...
          return _context2.a(2, res.status(400).json({
            message: "Credentials not assigned"
          }));
        case 6:
          res.status(200).json({
...
module.exports.unassignShop = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(req, res) {
    var _req$body2, shop_id, user_id, deleted;
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.n) {
        ...
        case 4:
          res.status(200).json({
            message: "Credentials unassigned successfully"
          });
        case 5:
  ...
  var _ref4 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4(req, res) {
    ...
    return _regenerator().w(function (_context4) {
      while (1) switch (_context4.n) {
        ...
        case 3:
          assignDeleted = _context4.v;
          _context4.n = 4;
          return productModel.deleteMany({
            shop_id: id
          });
        case 4:
          assignProduct = _context4.v;
          res.status(200).json({
      ...
      while (1) switch (_context5.n) {
        ...
        case 2:
          ...
          return _context5.a(2, res.status(200).json({
            message: "No Credentials assigned",
            shops: []
          }));
        case 3:
          res.status(200).json({
      ...
      while (1) switch (_context7.n) {
        ...
        case 1:
          ...
          return _context7.a(2, res.status(200).json({
            message: "No Credentials assigned yet",
            shops: []
          }));
        case 2:
          _context7.n = 3;
