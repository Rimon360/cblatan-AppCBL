...
module.exports.registerUser = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(req, res) {
    var _req$body, email, usagsLimit, password, role, client, userExists, solt, hashedPassword, random, user, _email, _role, _id, createdAt, ip_address, _seq;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        case 0:
          _req$body = req.body, email = _req$body.email, usagsLimit = _req$body.usagsLimit, password = _req$body.password, role = _req$body.role, client = _req$body.client;
          if (!role) role = "member";
    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.n) {
        case 0:
          ...
          ip = ((_req$headers$xForwar = req.headers['x-forwarded-for']) === null || _req$headers$xForwar === void 0 ? void 0 : _req$headers$xForwar.split(',')[0]) || req.socket.remoteAddress;
          if (ip) {
            _context2.n = 1;
            break;
          }
