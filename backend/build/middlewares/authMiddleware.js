...
var validateFields = function validateFields(req, res, next) {
  var _req$body = req.body,
    shop_id = _req$body.shop_id,
    domain = _req$body.domain,
    email = _req$body.email,
    password = _req$body.password,
    course_name = _req$body.course_name;
  var file_path = req === null || req === void 0 ? void 0 : req.file; // Assuming the file upload is handled by multer and file_path is available
