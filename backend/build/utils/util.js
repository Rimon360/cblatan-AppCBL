...
var prependToFile = function prependToFile(filePath, data) {
  try {
    ...
    var logFile = filePath.endsWith("/") ? filePath + "track.csv" : filePath + "/track.csv";
    var existingData = fs.existsSync(logFile) ? fs.readFileSync(logFile, "utf8") : "";
...
var sendEmail = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(subject, text, attachmentPath) {
